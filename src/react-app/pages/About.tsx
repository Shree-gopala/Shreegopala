  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1">
        ...
        <section class="py-12 md:py-16 bg-white"><div class="max-w-4xl mx-auto px-4 md:px-8 text-center flex flex-col items-center"><div><span class="text-orange-400 text-sm font-bold tracking-wider uppercase">
          About SGSC</span><h2 class="font-serif text-2xl md:text-3xl lg:text-4xl text-gray-900 font-bold mt-2 mb-6 leading-tight">We Are Here To Deliver Quality Chemicals For Your Industry</h2>
